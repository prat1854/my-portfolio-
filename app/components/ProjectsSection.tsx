...
const projects: Project[] = [
  ...
  },
  {
    ...
    impact: "Delivered a production-ready cloud-deployed platform featuring product catalog management, user authentication, cart functionality, payment processing, and centralized admin controls.",
    tech: [
      "React",
      "Redux",
      "Material UI",
