...
export default function HeroSection() {
  ...
  return (
    <header className="relative bg-[var(--background)] dark:bg-[var(--dark-bg)] text-[var(--text-color)] dark:text-white py-12 md:py-20 min-h-screen flex items-center overflow-hidden z-10 before:absolute before:inset-0 before:bg-gradient-to-br before:from-indigo-50/15 before:via-transparent before:to-pink-50/15 dark:before:from-indigo-950/30 dark:before:via-transparent dark:before:to-pink-950/30 before:animate-gradient-shift">
      <div className="container mx-auto px-8 md:px-12 lg:px-20 relative z-10">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between">
          ...
          >
            ...
            <motion.div
              ...
              className="text-lg md:text-xl text-[var(--text-color)] leading-relaxed space-y-4 md:space-y-6 font-normal"
            >
              <p>
                My name is Prateek Bajpai, I'm {" "}
                <span className="font-semibold text-indigo-700 dark:text-indigo-300 [text-shadow:0_0_10px_rgba(99,102,241,0.15)] dark:[text-shadow:0_0_15px_rgba(99,102,241,0.3)]">
                  <Typewriter
            ...
            >
              <Link
                ...
                className="flex items-center gap-2 bg-white border-2 border-indigo-600 text-indigo-900 px-4 sm:px-6 py-2 sm:py-3 rounded-sm font-semibold shadow-md hover:bg-indigo-600 hover:text-white hover:scale-105 transition-all duration-300" aria-label="View my LinkedIn profile"
                target="_blank"
              ...
              <Link
                ...
                className="flex items-center gap-2 bg-white border-2 border-indigo-600 text-indigo-700 px-4 sm:px-6 py-2 sm:py-3 rounded-sm font-semibold shadow-md hover:bg-indigo-600 hover:text-white hover:shadow-[0_4px_20px_rgba(99,102,241,0.4)] hover:scale-105 transition-all duration-300" aria-label="View my GitHub profile"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <Link
                href="/resume00.pdf"
                className="flex items-center gap-2 bg-white border-2 border-purple-600 text-purple-700 px-4 sm:px-6 py-2 sm:py-3 rounded-sm font-semibold shadow-md hover:bg-purple-600 hover:text-white hover:shadow-[0_4px_20px_rgba(147,51,234,0.4)] hover:scale-105 transition-all duration-300" aria-label="Download my resume"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <div className="mt-16 md:mt-10 flex justify-center">
          <motion.div
            ...
            className="text-[var(--text-color)] flex flex-col items-center hover:text-indigo-600 dark:hover:text-indigo-400 transition-all duration-300 cursor-pointer group font-medium"
